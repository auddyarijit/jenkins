		...
		<div class="container">
			<div class="ft-breadcrumb-content headline text-center position-relative">
				...
				<div class="ft-breadcrumb-list ul-li">
					<ul>
						<li><a href="<?php echo base_url(); ?>company_history">Home</a></li>
						<li>Company_History</li>
					</ul>
				</div>
			</div>
		</div>
					...
					<div class="col-lg-12">
						<div class="ft-about-text-wrapper-2">
							<div class="ft-section-title-2 headline pera-content">
								...
								<p> is a private limited company incorporated in the year 2022. Its shareholders and Directors are Shri M J Solanki (of MJ Solanki group) and Smt. Devika Sinha (Aajivika HR). It is primarily a ‘Business to Government’ (B2G) venture, coupled with expansion of pan-India market of sellers, to take them from ‘local to global’.<br>
								The current MTP of IGCPL is to become the end to end solution providers of GeM-platform based vendors in India, as well as, to partner sellers across India. Its vision is to truly achieve ease of business in India in B2G sector. Its mission is Increased RRR: Reach, Revenue, Retention of market. In addition, the company has plans to foray into cashflow management services and health-care services. 
								</p>
							</div>
							<div class="ft-about-feature-wrapper-2">
								...
								<div class="ft-btn-3">
									<a class="d-flex justify-content-center align-items-center" href="about.php">Explore More <i class="flaticon-right-arrow"></i></a>
								</div>
							</div>
						</div>
					</div>
...
<!-- Start of Footer   section
	============================================= -->
	<footer id="ft-footer-2" class="ft-footer-section-1" data-background="assets/img/bg/f-bg.png">
		<div class="ft-footer-newslatter position-relative">
			<div class="container">
				<div class="col-md-12 ft-footer-newslatter-content d-flex justify-content-between align-items-center flex-wrap">
						...
						<div class="ft-footer-widget ul-li-block headline pera-content">
							<div class="logo-widget">
								...
								<div class="ft-footer-address">
									<span><h3 class="widget-title">Register Address</h3> The Registered address of IGCPL is:
 										  Indigem Channel Partners Private Limited,305-306,3rd Floor, Tower A, Spacedge , Sector 46, Sohna Road, Gurgaon, Haryana, India 122018 
									</span>
									<span>Website: igcpl.com</span>
									<span>Email: indigeminfo@gmail.com</span>
									<span>Phone: +0 (000) 000 00 00</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="ft-footer-widget ul-li-block headline pera-content">
							<div class="menu-widget">
								...
								<ul>
									...
									<li><a href="service-single.php">Ocen Freight</a></li>
									<li><a href="service-single.php">Warehousing</a></li>
									<li><a href="service-single.php">Global stock transparency</a></li>
