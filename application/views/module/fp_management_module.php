	...
	<section id="ft-breadcrumb" class="ft-breadcrumb-section position-relative" data-background="assets/img/bg/bread-bg.jpg">
		...
		<div class="container">
			<div class="ft-breadcrumb-content headline text-center position-relative">
				<h2>FP Management Module</h2>
				<div class="ft-breadcrumb-list ul-li">
					<ul>
						<li><a href="#">Home</a></li>
						<li>FP Management Module</li>
					</ul>
				</div>
			</div>
		</div>
...
<!-- Start of contact page section
	...
	<section id="ft-contact-page" class="ft-contact-page-section page-padding">
					...
					<div class="col-lg-6">
						<div class="ft-contact-page-form-wrapper headline justify-content-center">
							<h3 class="text-center">Sign-up FP</h3>
							<form action="contact.php">
								<div class="row">
									...
									<div class="col-lg-6">
										<input type="text" name="affi" placeholder="Position">
									</div>
									<div class="col-lg-6">
